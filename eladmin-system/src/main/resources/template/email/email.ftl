...
<div style="height: auto;
    ...
    <div style="padding: 10px;padding-bottom: 0px;">
        ...
        <p style="text-indent: 2em; margin-bottom: 10px;">${title}</p>
        ...
        <div style="text-align: center;
            ...
            Copyright &copy;${.now?string("yyyy")} <a hover="color: #DA251D;" style="color: #999;" href="https://fengmuxi-chatgpt-web.hf.space" target="_blank">ChatGpt-Web</a>
        </div>
