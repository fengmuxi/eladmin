...
//        getHeders(request);
        String ip = request.getHeader("UserIp");
        if (ip == null || ip.length() == 0 || "unknown".equalsIgnoreCase(ip)) {
...
//        return object.get("addr", String.class);
        ...
        String addIp=data.get("country",String.class)+data.get("prov",String.class)+data.get("city",String.class)+data.get("district",String.class);
        log.info("[User IP]"+addIp);
        return addIp;
    }
